...
from pipecat.transports.audio import LocalAudioTransport, LocalAudioParams
...
class VoiceToolDeps:
    ...
    transport: Optional[LocalAudioTransport] = None
...
class VoiceCommandManager:
    ...
    async def initialize(self, command_callback: Callable[[str], None]):
        ...
        self.deps.transport = LocalAudioTransport(
            name="CompUse Voice",
